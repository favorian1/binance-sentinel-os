...
Binance Sentinel-OS runs on the open **Model Context Protocol (MCP)** standard.
Follow the steps below to go from zero to live trading in under 10 minutes.

---

## 📦 Step 0: Install Your Preferred AI Client (If Not Already Installed)

Before running Sentinel-OS, ensure your AI client CLI or editor is installed:
...
### Option C: Cursor AI or Windsurf IDE
- **Cursor AI**: Download and install from [cursor.com](https://cursor.com)
- **Windsurf**: Download and install from [codeium.com/windsurf](https://codeium.com/windsurf)

---

## 🧭 Step 1: Set Up Your Binance Account (All Platforms)
...
## 🛠️ Step 2: Configure Your Specific AI Platform
...
3. **Launch AGY & Authenticate**:
   ...
   - Click the official Binance login link generated by AGY, approve your sub-account, and return to chat.
...
- **Emergency Circuit Breaker**: Purges all open orders across Spot and Margin in under 1 second (`/stop`).
