...
## Authentication
- If the MCP connection is unauthenticated, initiate authentication through Claude Code's native `/mcp` menu by selecting `binance-agent-os` and approving the OAuth session in the browser.
